  ...
  <section class="flex flex-col min-w-[520px] w-full">
    ...
    <div class="flex items-center gap-3.5 pb-4 border-b border-dashed">
      <div>
        ...
        >
          <img src="/lain-chat.png" />
        </div>
      </div>
      <div>
        <div
          class="font-medium truncate max-w-[9rem] md:max-w-none text-gray-300"
        >
          Lain
        </div>
    ...
    <div class="text-center text-2xl py-12" v-if="pending">
      <svg
        ...
        stroke-width="1.5"
        stroke="currentColor"
        class="size-6 mx-auto animate-spin"
      >
        <path
    ...
    >
      ...
      <div
        ...
        :class="{ 'flex-row-reverse': !message.isLain }"
      >
        <!-- Profile Image -->
        <img
          v-if="message.isLain"
        ...
        >
          <!-- Message Content -->
          <div v-if="message.isLain" v-html="message.message"></div>
          <div v-else>
            {{ message.message }}
          </div>
          <!-- Time -->
